...
0x08048ed9           3da7010000  cmp eax, 0x1a7
0x08048ede                 7578  jne 0x8048f58
0x08048ee0       c7042448530c08  mov dword [esp], str._bin_sh
0x08048ee7           e8047d0000  call sym.__strdup
0x08048eec             89442410  mov dword [esp + 0x10], eax
0x08048ef0     c744241400000000  mov dword [esp + 0x14], 0
...
0x08048f4a       c7042448530c08  mov dword [esp], str._bin_sh
0x08048f51           e8eab60000  call sym.execv
0x08048f56                 eb28  jmp 0x8048f80
0x08048f58           a170e10e08  mov eax, dword [obj.stderr]
0x08048f5d                 89c2  mov edx, eax
0x08048f5f           b850530c08  mov eax, str.No___n
0x08048f64             8954240c  mov dword [esp + 0xc], edx
0x08048f68     c744240805000000  mov dword [esp + 8], 5
0x08048f70     c744240401000000  mov dword [esp + 4], 1
